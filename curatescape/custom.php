    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function() {
            ...
            var openstreet = L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
                attribution: '<a href="https://aisstream.io">aisstream.io/</a>, <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a>, <a href="http://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery © <a href="http://mapbox.com">Mapbox</a>',
                detectRetina: true,
                maxNativeZoom: 18,
                maxZoom: 21
            });
...
*/ ?>
            ...
            //-----Add custom NOAA chart map layers-----
<?php /*
...
*/ ?>
            ...
            var noaaMap1 = L.tileLayer("<?php echo url("tileserver/noaa12334_mb/{z}/{x}/{y}.png");?>", {
                zIndex: 5,
                detectRetina: true,
                maxZoom: 21
            });
...
<?php /*
            ...
            //});
*/ ?>
            var noaaMap2 = L.tileLayer("<?php echo url("tileserver/noaa12335_mb/{z}/{x}/{y}.png");?>", {
                zIndex: 6,
                detectRetina: true,
                maxZoom: 21
            });
                    ...
                    $.getJSON('/mtdata.json', function(mtdata_json) {
                        ...
                        for (mtind = 0; mtind < mtdata_json.length; mtind++) {
                            ...
                            if (mtvinfo.hasOwnProperty('SHIP_ID') && mtvinfo['SHIP_ID'] != 0) {
                                ...
                                mtMoreInfo = 
                                       "<span id='mtlink'><a target='_blank' href='http://www.vesselfinder.com/vessels/details/"
                            ...
                            var mtmark = L.marker([mtvinfo['LAT'], mtvinfo['LONG']],
                                 ...
                                 .bindPopup(
                                   ...
                                   + "<br/>courtesy of <span id='mtlink'><a href='https://aisstream.io/' target='_blank'>aisstream.io</a></span>"
                                    + "</span>"
                                   + "</div>"
                                   + "</div>"
                                  );
...
function mh_social_array(){
    ...
    array_push($services, '<a class="ext-social-link donate" href="https://portsidenewyork.networkforgood.com/projects/144802-main-giving-page" target="_blank"><span class="icon-donate" aria-hidden="true"></span><span class="social_label"> Donate Now</span></a>');
